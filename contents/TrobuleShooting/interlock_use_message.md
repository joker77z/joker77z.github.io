...
> 사실 이 두번째 방법과 비슷하게 다양한 방법을 시도했다. 대표적으로는 [B도메인 로그인] 팝업 창에서 [지원서 작성]창을 띄우면서 바로 [B도메인 로그인] 팝업을 종료하는 방법을 시도했는데, 이건 B도메인 로그인 팝업창을 스스로 끌 수 없었다. 교차 출처여서 동작하지 않는 것으로 확인된다. ([참조: ToastUI](https://ui.toast.com/posts/ko_20220831))
